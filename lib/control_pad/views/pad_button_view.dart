...
typedef PadButtonPressedCallback = void Function(int buttonIndex, Gestures gesture);
...
class PadButtonsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: Stack(children: createButtons(innerCircleSize, actualSize)));
  }
  ...
  Positioned createPositionedButtons(PadButtonItem paddButton, double actualSize, int index, double innerCircleSize) {
    return Positioned(
        ...
        return GestureDetector(
          ...
          onTapUp: (details) {
            ...
            Future.delayed(const Duration(milliseconds: 50), () {
              setState(() => buttonsStateMap![paddButton.index!] = paddButton.backgroundColor!);
            });
          },
          onTapDown: (details) {
            _processGesture(paddButton, Gestures.TAPDOWN);

            setState(() => buttonsStateMap![paddButton.index!] = paddButton.pressedColor!);
          },
          onTapCancel: () {
          ...
          child: Padding(
            ...
            child: CircleView.padButtonCircle(innerCircleSize, buttonsStateMap![paddButton.index]!, paddButton.buttonImage!,
                paddButton.buttonIcon!, paddButton.buttonText!),
          ),
        );
      }),
    );
