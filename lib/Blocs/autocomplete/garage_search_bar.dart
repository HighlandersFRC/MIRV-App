...
class GarageSearchBar extends StatelessWidget {
  ...
  GarageSearchBar({Key? key, required this.selectedGarageController, required this.typeAheadController}) : super(key: key);
  ...
  setSelectedLocation(String placeId) async {
    ...
    selectedGarageController.searchSelect.value = sLocation;
  }
