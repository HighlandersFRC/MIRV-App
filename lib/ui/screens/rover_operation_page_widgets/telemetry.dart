    ...
    return Container(
      ...
      child: Column(children: [
        Row(children: [
          ...
          Text("${roverMetrics.telemetry.speed} mph", style: TextStyle(fontSize: 20, color: Colors.white)),
        ]),
        Row(children: [
          const Icon(Icons.compass_calibration, color: Colors.white),
          const SizedBox(width: 5),
          Text("${roverMetrics.telemetry.heading}\u00B0", style: TextStyle(fontSize: 20, color: Colors.white)),
        ])
      ]),
    );
  }
