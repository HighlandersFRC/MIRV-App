...
extension DeviceHealthTypeColor1 on DeviceHealthType {
  MaterialStateProperty<Color> get color1 {
    var invalid1 = MaterialStateProperty.all(const Color.fromARGB(255, 103, 109, 105));
    var healthy1 = MaterialStateProperty.all(const Color.fromARGB(255, 21, 117, 58));
    var unhealthy1 = MaterialStateProperty.all(const Color.fromARGB(200, 238, 205, 19));
    var degraded1 = MaterialStateProperty.all(const Color.fromARGB(255, 190, 18, 18));
    switch (this) {
